...
# TODO Code for core_model.py and feature_eng_model.py has lots of repeated code, need to refactor this
...
training = ['high', 'open', 'low', 'volume', 'year', 'month', 'day', 'name_encoded', "lag_close_1", "ema_7", "volatility", "rsi"]
...
# this is important because all the features have different scales
...
# # TODO store the scalers for later use
...
# currently same model complexity as core_model.py
input_size = len(training)  # 12 features
